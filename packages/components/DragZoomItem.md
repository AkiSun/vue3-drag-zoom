...
<template>
  <drag-zoom-item class="draggable" v-model="transform">
    👋Drag me!
    <div style="color: gray;">I am at {{ transform.x }}, {{ transform.y }}</div>
  </drag-zoom-item>
</template>
...
```html
<drag-zoom-item class="draggable" drag-handle-class="handle" v-model="transform">
...
>
  👋Drag me & Zoom me!
  <div style="color: gray;">I am at {{ transform.x }}, {{ transform.y }}</div>
  <div style="color: gray;">and scale is {{ transform.scale }}</div>
</drag-zoom-item>
```
