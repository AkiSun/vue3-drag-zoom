  ...
  new (...args: any[]): {
      ...
      Omit<
        Readonly<
          import('vue').ExtractPropTypes<
            __VLS_WithDefaults<
              __VLS_TypePropsToRuntimeProps<DragZoomContainerProps>,
              {
                draggable: boolean
                zoomable: boolean
                zoomRange: () => Range
        ...
        > & {
          ...
          'onDrag-move'?:
            | ((newTransform: Transform, event: MouseEvent | TouchEvent) => any)
            | undefined
    ...
    $parent:
      | import('vue').ComponentPublicInstance<
        ...
        >
      | null
    $emit: ((event: 'change', newTransform: Transform) => void) &
      ((event: 'drag-start', event: MouseEvent | TouchEvent) => void) &
      ((event: 'drag-move', newTransform: Transform, event: MouseEvent | TouchEvent) => void) &
      ((event: 'drag-end', event: MouseEvent | TouchEvent) => void) &
      ((event: 'zoom', newTransform: Transform, event: WheelEvent) => void) &
      ((event: 'update:modelValue', transform: Transform) => void)
    $el: any
