...
declare const _default: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            draggable: boolean;
            zoomable: boolean;
        }> & Omit<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<DraggableProps>, {
            draggable: boolean;
            zoomable: boolean;
            zoomRange: () => Range;
        }>>> & {
        ...
        $el: any;
        $options: import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<DraggableProps>, {
            draggable: boolean;
            zoomable: boolean;
            zoomRange: () => Range;
        }>>> & {
    ...
    } & Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<DraggableProps>, {
        draggable: boolean;
        zoomable: boolean;
        zoomRange: () => Range;
    }>>> & {
...
} & import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<DraggableProps>, {
    draggable: boolean;
    zoomable: boolean;
    zoomRange: () => Range;
}>>> & {
